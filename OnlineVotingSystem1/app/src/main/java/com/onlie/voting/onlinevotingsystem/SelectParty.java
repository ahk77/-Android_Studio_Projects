...
public class SelectParty extends AppCompatActivity {
    ...
    Button Candidate1,Candidate2,Candidate3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Candidate1=(Button)findViewById(R.id.party1);
        Candidate2=(Button)findViewById(R.id.party2);
        Candidate3=(Button)findViewById(R.id.party3);
        Intent i=getIntent();
        ...
        Candidate1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                builder.setMessage("Do you want to give your vote to Candidate1");
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        mref.child("Users").child(Phone).child("Party").setValue("Party1").addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                ...
                                i.putExtra("partyname","Candidate 1");
        ...
        Candidate2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                final AlertDialog.Builder builder=new AlertDialog.Builder(SelectParty.this);
                builder.setTitle("Confirm Your Party");
                builder.setMessage("Do you want to give your vote to Candidate2");
                builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        mref.child("Users").child(Phone).child("Party").setValue("Party2").addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                ...
                                Intent i=new Intent(SelectParty.this,FinalActivity.class);
                                i.putExtra("phone",Phone);
                                i.putExtra("partyname","Candidate 2");
        ...
        Candidate3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                final AlertDialog.Builder builder=new AlertDialog.Builder(SelectParty.this);
                builder.setTitle("Confirm Your Party");
                builder.setMessage("Do you want to give your vote to Candidate3");
                builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        mref.child("Users").child(Phone).child("Party").setValue("Party3").addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                ...
                                Intent i=new Intent(SelectParty.this,FinalActivity.class);
                                i.putExtra("phone",Phone);
                                i.putExtra("partyname","Candidate 3");
